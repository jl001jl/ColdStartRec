...
class BaseModel(nn.Module):
    def __init__(self, 
        ...
        self.model_dir = os.path.join(kwargs["model_root"])
    ...
    def fit_generator(self, data_generator, epochs=1, validation_data=None,
        ...
        log_var = self.evaluate_generator(self.valid_gen)
        logging.info("initial loss".format(log_var))
    ...
    def evaluate_metrics(self, y_true, y_pred, metrics,**kwargs):
        return evaluate_metrics(y_true, y_pred, metrics,**kwargs)
